    ...
    return (
        <>
            ...
            {!hasBreakfast && <Box>
                ...
                }} id={"breakfast"}>Do you want to add breakfast
                    for {formatCurrency(optionalBreakfastPrice)}?</Checkbox>
            </Box>}

            <Box>
                <Checkbox checked={confirmPaid} onChange={() => setConfirmPaid(!confirmPaid)} id={"confirm"}
                          disabled={confirmPaid || isCheckingIn}>I confirm
